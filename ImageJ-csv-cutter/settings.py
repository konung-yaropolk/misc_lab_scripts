...
DIRECTORIES = [
    ...
    # 'F:\\LabWork\\2-photon\\TRP project Ca-imaging with DRS + TRPC3, TRPA1, TRPM3 activators + Caps\\',
    # '/run/media/lol/Yarik Data/LabWork/2-photon/TRP project Ca-imaging with DRS + TRPC3, TRPA1, TRPM3 activators + Caps/2024_07_23_M1/',
    # 'F:/LabWork/2-photon/Pirt_GCamp3 x MCU-KO + DRS + Caps/',
    # 'F:/LabWork/2-photon/Microglia + C5a/',
    # 'F:\\LabWork\\2-photon\\Pirt GCamp3 x Thy1 RGeco SNI or SHAM + DRS  + PMX205 + Bicuculine\\'
    # 'F:/LabWork/2-photon/Pirt GCamp3 x Thy1 RGeco + DRS + C5a',
    # 'F:/LabWork/2-photon/Pirt GCamp3 x Thy1 RGeco + DRS + Bicuculine/',
    # 'D:/LabWork/2-photon/TRP project Ca-imaging with DRS + TRPC3, TRPA1, TRPM3 activators + Caps/2024_04_29/',
    # 'C:/Users/yandrianov/Desktop/2024_07_22/',
    # 'D:/LabWork/2-photon/PI_Pirt_GCamp3_x_Thy1_RGeco_PP_and_fiber_typing/2025_05_20/'
    # 'F:/LabWork/2-photon/HSD2-brainstem-slices/2025_07_23/'
    # 'F:/LabWork/2-photon/PI_Pirt_GCamp3_x_Thy1_RGeco_PP_and_fiber_typing/2025_05_21/'
    # 'f:/LabWork/2-photon/Thy1-RGeco control/'
    # 'D:/LabWork/2-photon/HSD2-brainstem-slices/'
